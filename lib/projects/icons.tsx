...
// Shared SVG props
const S = { width: 20, height: 20, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 2.2, strokeLinecap: "round" as const, strokeLinejoin: "round" as const };
...
export const FEATURE_ICONS: Record<IconKey, React.ReactNode> = {
  ...
  SEO: <IcoSearch />,
  VisualSearch: <IcoEye />,
  SemanticSearch: <IcoCpu />,
  Personalized: <IcoTarget />,
  ModuleGraph: <IcoSearch />,
  RouteAnalyzer: <IcoGitBranch />,
  ProviderRegistry: <IcoSettings />,
